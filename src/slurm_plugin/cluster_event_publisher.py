...
class ClusterEventPublisher:
    ...
    def publish_unhealthy_node_events(self, ec2_missing_backing_instance_limit, unhealthy_nodes: List[SlurmNode]):
        ...
        nodes_with_invalid_backing_instance = [
            node for node in unhealthy_nodes if not node.is_backing_instance_valid(
